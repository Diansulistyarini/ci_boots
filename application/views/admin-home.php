            ...
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="container" style="margin-left: 5%;margin-top: 5%;">
                        <div class="row">
                            <div class="col">
                                <a href=">"><button type="button" class="btn btn-danger btn-lg" style="width: 30%; margin-left:-60px;"><?php echo $hasil;?><br>pengaduan baru</button></a>
                            </div>
                        </div>
                        <div class="row mt-5">
                            <div class="col-sm">
                                <a href=""><button type="button" class="btn btn-warning btn-lg" style="width: 30%; margin-left:300px; margin-top:-195px"><?php echo $hasil;?><br>pengaduan proses</button></a>
                            </div>
                        </div>
                        <div class="row mt-5">
                            <div class="col-sm">
                                <a href=""><button type="button" class="btn btn-success btn-lg" style="width: 30%;margin-left:670px; margin-top:-330px"><?php echo $hasil;?><br>pengaduan selesai</button></a>
                            </div>
                        </div>
                    </div>
