...
<body>
    ...
    <div class="wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="width:900px; margin-left:-15px">
        ...
        <form action="<?php echo site_url('Dashboard/save_report'); ?>" method="POST" enctype="multipart/form-data" >
            <div class="row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5" >
                    <input type="gambar" name="files" class="form-control-file" id="exampleFormControlFile1">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-5">
                    <button class="btn btn-secondary" type="submit" style="margin-left:500px ;">Submit form</button>
                    </div>
                </div>
