...
<body>
    ...
    <div class="card">
        ...
        <form method="post" class="reg" action="<?php echo site_url('Dashboard/save_ofc') ?>">
            <div style="width: 0px; height: 280px; border: 1px #000 solid; margin-top: 10px;"></div>
            <h2 class="text_login">SIGN UP</h2>
            <input type="text" name="namas" class="form_login" placeholder="     Nama Petugas...">
            <br>
            ...
            <br>
            <input type="text" name="level" class="form_login" placeholder="     Level...">
